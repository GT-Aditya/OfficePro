package com.boot.officeproject.controller.companycontroller;
...
import com.boot.officeproject.model.companymodel.Company;
...
public class CompanyController {
    ...
    //add Company
    @PostMapping("/company")
    public List<Company> addCompany(@RequestBody Company company)  throws SQLException, IOException{
        ...
        // ClassPath path = new ClassPathResource(path)
        ...
        if(company.getBank()==null) company.setBank(new ArrayList<CompanyBankDetails>());
        ...
        if(company.getiBankDetails()==null) company.setiBankDetails(new ArrayList<IntermediateryBankDetail>());
